...
const maxLogoSizeInBase64 = kbToBase64Length(200); // inspired by x-pack/plugins/canvas/common/lib/dataurl.ts
...
const PdfLogoSchema = _configSchema.schema.nullable(_configSchema.schema.string({
