...
const metricSets = {
  advanced: [{
    ...
    keys: ['node_index_mem_query_cache', 'node_index_mem_request_cache', 'node_index_mem_fielddata', 'node_index_mem_writer'],
    name: 'node_index_4'
  }, {
    ...
    keys: ['node_index_threads_search_queue', 'node_index_threads_search_rejected', 'node_index_threads_get_queue', 'node_index_threads_get_rejected'],
  ...
  }, 'node_load_average', 'node_segment_count']
};
exports.metricSets = metricSets;