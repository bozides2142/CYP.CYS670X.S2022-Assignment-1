...
const metricSet = [{
  ...
  keys: [// 'apm_responses_count',
  'apm_responses_errors_toolarge', 'apm_responses_errors_validate', 'apm_responses_errors_method', 'apm_responses_errors_unauthorized', 'apm_responses_errors_ratelimit', 'apm_responses_errors_queue', 'apm_responses_errors_decode', 'apm_responses_errors_forbidden', 'apm_responses_errors_concurrency', 'apm_responses_errors_closed', 'apm_responses_errors_internal'],
  name: 'apm_responses_errors'
}, {
  keys: ['apm_requests'],
  name: 'apm_requests'
}, {
  keys: ['apm_processor_transaction_transformations', 'apm_processor_span_transformations', 'apm_processor_error_transformations', 'apm_processor_metric_transformations'],
  name: 'apm_transformations'
}, {
  keys: ['apm_acm_response_count', 'apm_acm_response_errors_count', 'apm_acm_response_valid_ok', 'apm_acm_response_valid_notmodified'],
  name: 'apm_acm_response'
}, {
  keys: ['apm_acm_response_errors_forbidden', 'apm_acm_response_errors_unauthorized', 'apm_acm_response_errors_unavailable', 'apm_acm_response_errors_method', 'apm_acm_response_errors_invalidquery'],
