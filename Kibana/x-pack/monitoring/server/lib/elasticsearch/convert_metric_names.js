...
exports.convertMetricNames = convertMetricNames;
exports.uncovertMetricNames = uncovertMetricNames;

var _lodash = require("lodash");

var _nodes_listing_metrics = require("./nodes/get_nodes/nodes_listing_metrics");
/*
...
function convertMetricNames(prefix, metricObj) {
  return Object.entries(metricObj).reduce((newObj, [key, value]) => {
    const newValue = (0, _lodash.cloneDeep)(value);
...
function uncovertMetricNames(byDateBucketResponse) {
  const unconverted = {};

  for (const metricName of _nodes_listing_metrics.LISTING_METRICS_NAMES) {
