...
function handleResponse(response, start, end) {
  ...
  const {
    ...
    const rateOptions = {
      hitTimestamp: (_ref = (_stats$timestamp = stats === null || stats === void 0 ? void 0 : stats.timestamp) !== null && _stats$timestamp !== void 0 ? _stats$timestamp : hit._source['@timestamp']) !== null && _ref !== void 0 ? _ref : null,
      earliestHitTimestamp: (_ref2 = (_earliestStats$timest = (_earliestStats = earliestStats) === null || _earliestStats === void 0 ? void 0 : _earliestStats.timestamp) !== null && _earliestStats$timest !== void 0 ? _earliestStats$timest : (_hit$inner_hits3 = hit.inner_hits) === null || _hit$inner_hits3 === void 0 ? void 0 : (_hit$inner_hits3$earl = _hit$inner_hits3.earliest.hits) === null || _hit$inner_hits3$earl === void 0 ? void 0 : _hit$inner_hits3$earl.hits[0]._source['@timestamp']) !== null && _ref2 !== void 0 ? _ref2 : null,
      timeWindowMin: start,
      timeWindowMax: end
    };
    const {
    ...
    accum.beats.push({
      ...
      cgroup_memory: (_hit$_source$beats_st9 = hit._source.beats_stats) === null || _hit$_source$beats_st9 === void 0 ? void 0 : (_hit$_source$beats_st10 = _hit$_source$beats_st9.metrics) === null || _hit$_source$beats_st10 === void 0 ? void 0 : (_hit$_source$beats_st11 = _hit$_source$beats_st10.beat) === null || _hit$_source$beats_st11 === void 0 ? void 0 : (_hit$_source$beats_st12 = _hit$_source$beats_st11.cgroup) === null || _hit$_source$beats_st12 === void 0 ? void 0 : _hit$_source$beats_st12.memory.mem.usage.bytes,
      version: stats === null || stats === void 0 ? void 0 : (_stats$beat5 = stats.beat) === null || _stats$beat5 === void 0 ? void 0 : _stats$beat5.version,
      time_of_last_event: (_hit$_source$beats_st13 = (_hit$_source$beats_st14 = hit._source.beats_stats) === null || _hit$_source$beats_st14 === void 0 ? void 0 : _hit$_source$beats_st14.timestamp) !== null && _hit$_source$beats_st13 !== void 0 ? _hit$_source$beats_st13 : hit._source['@timestamp']
    });
    return accum;
  }, initial);
  return beats;
...
async function getApms(req, apmIndexPattern, clusterUuid) {
  ...
  const params = {
    ...
    'hits.hits._source.timestamp', 'hits.hits._source.@timestamp', 'hits.hits._source.beats_stats.beat.uuid', 'hits.hits._source.beats_stats.beat.name', 'hits.hits._source.beats_stats.beat.host', 'hits.hits._source.beats_stats.beat.type', 'hits.hits._source.beats_stats.beat.version', 'hits.hits._source.beats_stats.metrics.libbeat.output.type', 'hits.hits._source.beats_stats.metrics.libbeat.output.read.errors', 'hits.hits._source.beats_stats.metrics.libbeat.output.write.errors', 'hits.hits._source.beats_stats.metrics.beat.memstats.memory_alloc', 'hits.hits._source.beats_stats.metrics.beat.cgroup.memory.mem.usage.bytes', 'hits.hits._source.beat.stats.beat.uuid', 'hits.hits._source.beat.stats.beat.name', 'hits.hits._source.beat.stats.beat.host', 'hits.hits._source.beat.stats.beat.type', 'hits.hits._source.beat.stats.beat.version', 'hits.hits._source.beat.stats.libbeat.output.type', 'hits.hits._source.beat.stats.libbeat.output.read.errors', 'hits.hits._source.beat.stats.libbeat.output.write.errors', 'hits.hits._source.beat.stats.memstats.memory.alloc', // latest hits for calculating metrics
    'hits.hits._source.beats_stats.timestamp', 'hits.hits._source.beats_stats.metrics.libbeat.output.write.bytes', 'hits.hits._source.beats_stats.metrics.libbeat.pipeline.events.total', 'hits.hits._source.beat.stats.libbeat.output.write.bytes', 'hits.hits._source.beat.stats.libbeat.pipeline.events.total', // earliest hits for calculating metrics
    'hits.hits.inner_hits.earliest.hits.hits._source.beats_stats.timestamp', 'hits.hits.inner_hits.earliest.hits.hits._source.beats_stats.metrics.libbeat.output.write.bytes', 'hits.hits.inner_hits.earliest.hits.hits._source.beats_stats.metrics.libbeat.pipeline.events.total', 'hits.hits.inner_hits.earliest.hits.hits._source.@timestamp', 'hits.hits.inner_hits.earliest.hits.hits._source.beat.stats.libbeat.output.write.bytes', 'hits.hits.inner_hits.earliest.hits.hits._source.beat.stats.libbeat.pipeline.events.total', // earliest hits for calculating diffs
    'hits.hits.inner_hits.earliest.hits.hits._source.beats_stats.metrics.libbeat.output.read.errors', 'hits.hits.inner_hits.earliest.hits.hits._source.beats_stats.metrics.libbeat.output.write.errors', 'hits.hits.inner_hits.earliest.hits.hits._source.beats_stats.metrics.libbeat.output.read.errors', 'hits.hits.inner_hits.earliest.hits.hits._source.beats_stats.metrics.libbeat.output.write.errors'],
    body: {
