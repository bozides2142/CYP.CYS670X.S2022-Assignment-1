...
exports.response = exports.defaultResponseSort = void 0;
/*
...
const defaultResponseSort = handleResponse => {
  const responseMulti = {
    hits: {
      hits: []
    }
  ...
  return {
    beats: handleResponse(responseMulti, 0, 0),
    version
  };
};

exports.defaultResponseSort = defaultResponseSort;