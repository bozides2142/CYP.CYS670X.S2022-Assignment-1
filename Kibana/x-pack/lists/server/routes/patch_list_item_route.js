...
exports.patchListItemRoute = void 0;
...
const patchListItemRoute = router => {
  router.patch({
    options: {
    ...
    validate: {
      body: (0, _utils.buildRouteValidation)(_securitysolutionIoTsListTypes.patchListItemSchema)
    }
...
exports.patchListItemRoute = patchListItemRoute;