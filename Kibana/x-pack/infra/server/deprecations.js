...
const DEFAULT_VALUES = {
  ...
  tiebreaker: _constants.TIEBREAKER_FIELD,
  container: _constants.CONTAINER_FIELD,
  host: _constants.HOST_FIELD,
  pod: _constants.POD_FIELD
};
...
const configDeprecations = ({
  deprecate
}) => [...Object.keys(FIELD_DEPRECATION_FACTORIES).map(key => (completeConfig, rootPath, addDeprecation) => {
