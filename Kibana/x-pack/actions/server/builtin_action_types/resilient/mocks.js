...
exports.severity = exports.resilientFields = exports.incidentTypes = exports.externalServiceMock = exports.executorParams = exports.apiParams = void 0;
/*
...
const resilientFields = [{
  ...
  operations: ['equals', 'not_equals', 'contains', 'not_contains', 'changed', 'changed_to', 'not_changed_to', 'has_a_value', 'not_has_a_value'],
  operation_perms: {
    changed_to: {
...
exports.resilientFields = resilientFields;
...
exports.incidentTypes = incidentTypes;
const severity = [{
  value: 4,
  label: 'Low',
  enabled: true,
