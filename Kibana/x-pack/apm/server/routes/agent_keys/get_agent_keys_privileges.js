...
exports.getAgentKeysPrivileges = getAgentKeysPrivileges;
/*
...
async function getAgentKeysPrivileges({
  context,
  securityPluginStart
}) {
  const [securityHasPrivilegesResponse, areApiKeysEnabled] = await Promise.all([context.core.elasticsearch.client.asCurrentUser.security.hasPrivileges({
    body: {
