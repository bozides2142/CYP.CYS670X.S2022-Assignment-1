...
exports.FLEET_GLOBAL_COMPONENT_TEMPLATE_NAME = exports.FLEET_GLOBAL_COMPONENT_TEMPLATE_CONTENT = exports.FLEET_FINAL_PIPELINE_VERSION = exports.FLEET_FINAL_PIPELINE_ID = exports.FLEET_FINAL_PIPELINE_CONTENT = void 0;
...
const FLEET_GLOBAL_COMPONENT_TEMPLATE_NAME = '.fleet_component_template-1';
exports.FLEET_GLOBAL_COMPONENT_TEMPLATE_NAME = FLEET_GLOBAL_COMPONENT_TEMPLATE_NAME;
const FLEET_GLOBAL_COMPONENT_TEMPLATE_CONTENT = {
  _meta: meta,
  template: {
    settings: {
      index: {
...
exports.FLEET_GLOBAL_COMPONENT_TEMPLATE_CONTENT = FLEET_GLOBAL_COMPONENT_TEMPLATE_CONTENT;
const FLEET_FINAL_PIPELINE_VERSION = 2; // If the content is updated you probably need to update the FLEET_FINAL_PIPELINE_VERSION too to allow upgrade of the pipeline
