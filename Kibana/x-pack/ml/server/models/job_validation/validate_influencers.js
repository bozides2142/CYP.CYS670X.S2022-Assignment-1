...
exports.validateInfluencers = validateInfluencers;
...
async function validateInfluencers(job) {
  ...
  if ((influencers === null || influencers === void 0 ? void 0 : influencers.length) === 0 && job.analysis_config.detectors.length === 1 && detectorFieldNames.length === 0) {
    return Promise.resolve([]);
  }

  if ( // @ts-expect-error influencers is optional
  influencers.length <= INFLUENCER_LOW_THRESHOLD && detectorFieldNames.length >= DETECTOR_FIELD_NAMES_THRESHOLD) {
