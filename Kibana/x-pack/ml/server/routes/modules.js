...
function recognize(client, mlClient, savedObjectsClient, dataViewsService, jobSavedObjectService, request, indexPatternTitle) {
  const dr = (0, _data_recognizer.dataRecognizerFactory)(client, mlClient, savedObjectsClient, dataViewsService, jobSavedObjectService, request);
  return dr.findMatches(indexPatternTitle);
}

function getModule(client, mlClient, savedObjectsClient, dataViewsService, jobSavedObjectService, request, moduleId) {
  const dr = (0, _data_recognizer.dataRecognizerFactory)(client, mlClient, savedObjectsClient, dataViewsService, jobSavedObjectService, request);
...
function setup(client, mlClient, savedObjectsClient, dataViewsService, jobSavedObjectService, request, moduleId, prefix, groups, indexPatternName, query, useDedicatedIndex, startDatafeed, start, end, jobOverrides, datafeedOverrides, estimateModelMemory, applyToAllSpaces) {
  const dr = (0, _data_recognizer.dataRecognizerFactory)(client, mlClient, savedObjectsClient, dataViewsService, jobSavedObjectService, request);
  return dr.setup(moduleId, prefix, groups, indexPatternName, query, useDedicatedIndex, startDatafeed, start, end, jobOverrides, datafeedOverrides, estimateModelMemory, applyToAllSpaces);
}

function dataRecognizerJobsExist(client, mlClient, savedObjectsClient, dataViewsService, jobSavedObjectService, request, moduleId) {
  const dr = (0, _data_recognizer.dataRecognizerFactory)(client, mlClient, savedObjectsClient, dataViewsService, jobSavedObjectService, request);
...
function dataRecognizer({
  ...
  router.get({
    ...
    validate: {
      params: _modules.modulesIndexPatternTitleSchema
    },
    options: {
    ...
    try {
      ...
      const results = await recognize(client, mlClient, context.core.savedObjects.client, dataViewService, jobSavedObjectService, request, indexPatternTitle);
      return response.ok({
        body: results
      });
    } catch (e) {
  ...
  router.get({
    ...
    validate: {
      params: _modules.optionalModuleIdParamSchema
    },
    options: {
    ...
    try {
      ...
      const dataViewService = await getDataViewsService();
      const results = await getModule(client, mlClient, context.core.savedObjects.client, dataViewService, jobSavedObjectService, request, moduleId);
      return response.ok({
        body: results
      });
    } catch (e) {
  ...
  router.post({
    ...
    validate: {
      params: _modules.moduleIdParamSchema,
    ...
    try {
      ...
      const dataViewService = await getDataViewsService();
      const result = await setup(client, mlClient, context.core.savedObjects.client, dataViewService, jobSavedObjectService, request, moduleId, prefix, groups, indexPatternName, query, useDedicatedIndex, startDatafeed, start, end, jobOverrides, datafeedOverrides, estimateModelMemory, applyToAllSpaces);
      return response.ok({
        body: result
      });
    } catch (e) {
  ...
  router.get({
    ...
    try {
      ...
      const dataViewService = await getDataViewsService();
      const result = await dataRecognizerJobsExist(client, mlClient, context.core.savedObjects.client, dataViewService, jobSavedObjectService, request, moduleId);
      return response.ok({
        body: result
      });
    } catch (e) {
