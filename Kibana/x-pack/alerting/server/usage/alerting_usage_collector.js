...
exports.createAlertingUsageCollector = createAlertingUsageCollector;
exports.registerAlertingUsageCollector = registerAlertingUsageCollector;
...
const byTaskStatusSchemaByType = {
  // TODO: Find out an automated way to populate the keys or reformat these into an array (and change the Remote Telemetry indexer accordingly)
  DYNAMIC_KEY: byTypeSchema,
  failed: byTypeSchema,
...
function createAlertingUsageCollector(usageCollection, taskManager) {
...
function registerAlertingUsageCollector(usageCollection, taskManager) {
