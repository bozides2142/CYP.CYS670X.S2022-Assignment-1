...
function loadTemplates() {
  ...
  require('./pitch_presentation').pitch, // eslint-disable-next-line @typescript-eslint/no-var-requires
  require('./status_report').status, // eslint-disable-next-line @typescript-eslint/no-var-requires
  require('./summary_report').summary, // eslint-disable-next-line @typescript-eslint/no-var-requires
  require('./theme_dark').dark, // eslint-disable-next-line @typescript-eslint/no-var-requires
