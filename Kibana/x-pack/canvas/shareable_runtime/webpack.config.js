...
module.exports = {
  ...
  module: {
    rules: [{
      ...
      use: [{
        ...
        options: {
          additionalData(content, loaderContext) {
            return `@import ${stringifyRequest(loaderContext, path.resolve(KIBANA_ROOT, 'src/core/public/core_app/styles/_globals_v8light.scss'))};\n${content}`;
          },
      ...
      test: [require.resolve('@elastic/eui/es/components/drag_and_drop'), require.resolve('highlight.js')],
