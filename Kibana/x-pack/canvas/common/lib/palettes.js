...
exports.yellowRed = exports.yellowGreen = exports.yellowBlue = exports.paulTor21 = exports.paulTor14 = exports.palettes = exports.instagram = exports.identifyPartialPalette = exports.identifyPalette = exports.greenBlueRed = exports.elasticYellow = exports.elasticTeal = exports.elasticPurple = exports.elasticPink = exports.elasticOrange = exports.elasticGreen = exports.elasticBlue = exports.earthTones = exports.colorBlind = exports.canvas = void 0;
...
const identifyPartialPalette = input => {
  return palettes.find(palette => {
    const {
      colors,
      gradient
    } = palette;
    return gradient === input.gradient && (0, _lodash.difference)(input.colors, colors).length === 0;
  });
};

exports.identifyPartialPalette = identifyPartialPalette;
