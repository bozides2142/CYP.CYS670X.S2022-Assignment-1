...
exports.adjustTransaction = adjustTransaction;
...
var PerformanceMonitoring = function () {
      ...
      if (_data && _data.span) {
        ...
        if (_data.status != 'abort') {
          if (status >= 400 || status == 0) {
            outcome = _constants.OUTCOME_FAILURE;
          } else {
            outcome = _constants.OUTCOME_SUCCESS;
          }
        }
        ...
        if (tr && tr.type === _constants.HTTP_REQUEST_TYPE) {
          tr.outcome = outcome;
        }
  ...
  _proto.injectDtHeader = function injectDtHeader(span, target) {
    ...
    if (isHeaderValid && headerValue && headerName) {
      (0, _utils.setRequestHeader)(target, headerName, headerValue);
    }
  };

  _proto.injectTSHeader = function injectTSHeader(span, target) {
    var headerValue = (0, _utils.getTSHeaderValue)(span);

    if (headerValue) {
      (0, _utils.setRequestHeader)(target, 'tracestate', headerValue);
    }
  };
