...
export var isScriptedPhraseFilter = function isScriptedPhraseFilter(filter) {
  return has(filter, 'query.script.script.params.value');
};
/** @internal */

export var getPhraseFilterField = function getPhraseFilterField(filter) {
  var _ref, _filter$query$match_p;
...
export var getPhraseFilterValue = function getPhraseFilterValue(filter) {
  if (isPhraseFilter(filter)) {
    ...
    return (_filter$query = filter.query) === null || _filter$query === void 0 ? void 0 : (_filter$query$script = _filter$query.script) === null || _filter$query$script === void 0 ? void 0 : (_filter$query$script$ = _filter$query$script.script) === null || _filter$query$script$ === void 0 ? void 0 : (_filter$query$script$2 = _filter$query$script$.params) === null || _filter$query$script$2 === void 0 ? void 0 : _filter$query$script$2.value;
  }
};
/**
