 ...
 * @public
 */
export var COMPARE_ALL_OPTIONS = {
  index: true,
  disabled: true,
  negate: true,
  state: true,
...
var mapFilter = function mapFilter(filter, comparators, excludedAttributes) {
  var _filter$meta, _filter$meta2;

  var cleaned = omit(filter, excludedAttributes);
...
var mapFilterArray = function mapFilterArray(filters, comparators, excludedAttributes) {
...
export var compareFilters = function compareFilters(first, second) {
