...
exports.createExceptionListSchema = void 0;
 ...
 */
const createExceptionListSchema = t.intersection([t.exact(t.type({
  description: _description.description,
  name: _name.name,
  type: _exception_list.exceptionListType
})), t.exact(t.partial({
  list_id: _securitysolutionIoTsTypes.DefaultUuid,
...
exports.createExceptionListSchema = createExceptionListSchema;