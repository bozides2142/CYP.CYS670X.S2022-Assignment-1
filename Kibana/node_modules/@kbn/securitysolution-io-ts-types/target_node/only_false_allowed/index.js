...
exports.OnlyFalseAllowed = void 0;
 ...
 */
const OnlyFalseAllowed = new t.Type('DefaultBooleanTrue', t.boolean.is, (input, context) => {
  if (input == null) {
...
exports.OnlyFalseAllowed = OnlyFalseAllowed;