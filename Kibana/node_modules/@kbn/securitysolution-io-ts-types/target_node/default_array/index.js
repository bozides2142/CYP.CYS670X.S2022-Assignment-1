 ...
 */
const DefaultArray = codec => {
  const arrType = t.array(codec);
  return new t.Type('DefaultArray', arrType.is, (input, context) => input == null ? t.success([]) : arrType.validate(input, context), t.identity);
};
