...
exports.nonEmptyOrNullableStringArray = void 0;
 ...
 *
 */
const nonEmptyOrNullableStringArray = new t.Type('NonEmptyOrNullableStringArray', t.array(t.string).is, (input, context) => {
  const emptyValueFound = Array.isArray(input) && input.some(value => value === '');
  const nonStringValueFound = Array.isArray(input) && input.some(value => typeof value !== 'string');
...
exports.nonEmptyOrNullableStringArray = nonEmptyOrNullableStringArray;