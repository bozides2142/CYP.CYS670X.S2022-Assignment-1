...
function peg$parse(input, options) {
  ...
  var peg$startRuleFunctions = { expression: peg$parseexpression, argument: peg$parseargument };
  ...
  var peg$f11 = function(string) { // this also matches nulls, booleans, and numbers
