...
function isRelativeUrl(candidatePath) {
  ...
  const all = (0, _url.parse)(candidatePath, false
  /* parseQueryString */
  , true
  /* slashesDenoteHost */
  );
  const {
    ...
    hostname,
    port
  } = all; // We should explicitly compare `protocol`, `port` and `hostname` to null to make sure these are not
