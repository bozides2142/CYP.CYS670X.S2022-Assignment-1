 ...
 */
const DefaultSeverityMappingArray = new t.Type('DefaultSeverityMappingArray', _severity_mapping.severity_mapping.is, (input, context) => input == null ? t.success([]) : _severity_mapping.severity_mapping.validate(input, context), t.identity);
