...
const DefaultPage = new t.Type('DefaultPerPage', t.number.is, (input, context) => {
  if (input == null) {
    ...
    return _securitysolutionIoTsTypes.PositiveIntegerGreaterThanZero.validate(parseInt(input, 10), context);
  } else {
    return _securitysolutionIoTsTypes.PositiveIntegerGreaterThanZero.validate(input, context);
  }
}, t.identity);
