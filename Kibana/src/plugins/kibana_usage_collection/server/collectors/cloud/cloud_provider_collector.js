 ...
 */
function registerCloudProviderUsageCollector(usageCollection) {
  const cloudDetector = new _detector.CloudDetector(); // determine the cloud service in the background
