...
const font = {
  ...
  args: {
    ...
    sizeUnit: {
      default: `px`,
      help: _i18n.i18n.translate('expressions.functions.font.args.sizeUnitHelpText', {
  ...
  fn: (input, args) => {
    ...
    const availableSizeUnits = [_types.FontSizeUnit.PX, _types.FontSizeUnit.PT];

    if (args.sizeUnit && !availableSizeUnits.includes(args.sizeUnit)) {
      throw new Error(_i18n.i18n.translate('expressions.functions.font.invalidSizeUnitErrorMessage', {
