...
exports.movingAverageFn = void 0;
  ...
  return { ...input,
    ...
    rows: input.rows.map(row => {
      ...
      if (currentValue != null) {
        lastNValuesByBucket[bucketIdentifier] = [...(lastNValues || []), Number(currentValue)].slice(-window);
      }
...
exports.movingAverageFn = movingAverageFn;