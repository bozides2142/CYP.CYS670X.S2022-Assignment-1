...
var _create_default_inspector_adapters = require("./create_default_inspector_adapters");

Object.keys(_create_default_inspector_adapters).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _create_default_inspector_adapters[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _create_default_inspector_adapters[key];
    }
  });
});