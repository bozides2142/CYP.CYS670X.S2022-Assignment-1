 ...
 */
const typeSpecs = [_boolean.boolean, _datatable.datatable, _error.error, _filter.filter, _image.image, _null.nullType, _num.num, _number.number, _pointseries.pointseries, _range.range, _render.render, _shape.shape, _string.string, _style.style, _ui_setting.uiSetting];
