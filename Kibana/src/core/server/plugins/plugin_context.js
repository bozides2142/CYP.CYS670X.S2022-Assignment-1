...
exports.createPluginPrebootSetupContext = createPluginPrebootSetupContext;
...
function createPluginPrebootSetupContext(coreContext, deps, plugin) {
  return {
    elasticsearch: {
    ...
    preboot: {
      ...
      holdSetupUntilResolved: (reason, promise) => deps.preboot.holdSetupUntilResolved(plugin.name, reason, promise)
    }
  };
}
/**
